...
\section{Introduction}
 In college, students often rely on mess food for their daily meals, but there can be many reasons why they may miss out on a meal or prefer certain types of food over others.For this project, we conducted a survey among students at our college to gather data on their food preferences, how many times they skip the meals, their reasons for missing mess food etc. Our aim was to analyze the data and gain insights into the food habits and preferences of college students, which could help improve the quality and variety of food offered in our mess.
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.7]{side-by-side.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.7]{normality_plot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.7]{bar_department.png}
    \caption{Branches vs number of responses bar graph}  
    \label{fig:Normality_plot}
\end{figure}
This graph shows that the people who responded the most are from Civil, BM/BT, Electrical, and Mechanical.
...
\begin{figure}[H]
    ...
    \label{Normality_plot}
\end{figure}
From the histograms, it is evident that the plot is right skewed which means that the people missing food more than 10 times a week are less. People mostly skip meals 2 to 7 times a week.

\centerline{\underline{\bfseries{We will have a look on some pie charts now}}}
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.7]{pie_food_pref.png}
    \caption{Food preference pie chart}  
    \label{Normality_plot}
\end{figure}
This pie chart shows regional food preferences of the people in IITH. We can observe that people are not very particular about their food preferences.
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.7]{pie_gender.png}
    % \caption{Normal Probability Plot}  
    \label{Normality_plot}
\end{figure}
The charts compare male to female responses. we see that nearly one third of total responses came from males
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.7]{pie_income.png}
    % \caption{Normal Probability Plot}  
    \label{Normality_plot}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.7]{pie_plot_weekdays.png}
    % \caption{Normal Probability Plot}  
    \label{Normality_plot}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.7]{pie_skip_categoty.png}
    % \caption{Normal Probability Plot}  
    \label{Normality_plot}
\end{figure}
...
\begin{figure}[H]
    \hspace{-22mm}% 
    \centering
    \includegraphics[scale = 0.7]{pie_sleep_categoty.png}
    \caption{Normal Probability Plot}  
    \label{Normality_plot}
\end{figure}
This pie chart compares Early sleepers vs Late sleepers in the responses. From this chart, we can infer that the majority of them are Late sleepers!!
% \centerline{\underline{\bfseries{Veg Vs}}}
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.7]{pie_veg_non-veg.png}
    \caption{Normal Probability Plot}  
    \label{Normality_plot}
\end{figure}
This pie chart compares Non-veg eaters vs veg eaters in the responses. From this chart, we can infer that there are 2 times non-veg eaters as veg eaters!!
...
\textbf{$H_a$} : The mean count of students who skip mess during weekdays is greater than that of students who skip mess during week-ends.
\begin{center}
...
Here, Sample is the Undergraduate students who skip mess.\\
Sample size n = 127.\\
Now, we set up the research hypotheses :\\
$H_0$ : Mean count of Undergraduate students who skip mess is 6.\\
$H_a$ : Mean count of Undergraduate students who skip mess is different from 6.
\begin{center}
...
\item{\textbf{Case-3: Verifying if the variability in count of students of age 19-20 years who skip mess is less than 7 with 0.05 as level of significance.}}\\
Here, Sample is the 19-20 years age students who skip mess.
Let's now declare the null and altrenate hypothesis,\\
