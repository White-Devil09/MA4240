...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 1]{pie_food_pref.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 1]{pie_gender.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 1]{pie_income.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 1]{pie_plot_weekdays.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.77]{pie_skip_categoty.png}
